...
export default function Hero() {
  ...
  return (
    <div className=" h-auto sm:min-h-screen w-full rounded-md flex md:items-center md:justify-center bg-white dark:bg-black/[0.96] antialiased bg-grid-white/[0.02] relative overflow-hidden m-auto">
      <Spotlight
