    ...
    <div className="h-[40rem] w-full rounded-md bg-white dark:bg-neutral-950 relative flex flex-col items-center justify-center antialiased">
      <div className="max-w-2xl mx-auto p-4">
        ...
        <div className="relative z-10 mt-10 space-y-4">
            <form onSubmit={handleSubmit} suppressHydrationWarning className="grid grid-cols-1 gap-4">
              ...
              <div className="flex justify-center">
                 <Button disabled={loading} variant="primary" size="lg" className="z-10 w-full md:w-auto">
