...
export default async function ProjectDetailPage({
  ...
  if (!project || project.isHidden) {
    return (
      <div className="min-h-screen pt-28 pb-12 flex items-center justify-center text-2xl font-bold dark:text-white text-black">
        Project not found
      </div>
    );
  }
              ...
              <div className="w-full">
                ...
                <div className="mt-8">
                  ...
                  <div className="flex items-center gap-2">
                    <div className="w-[10px] h-[10px] rounded-full bg-[#50E3C2]" />
