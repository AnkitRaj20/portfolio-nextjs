            ...
            <div className="relative pl-20 pr-4 md:pl-4 w-full">
              ...
              <div className="flex flex-col gap-4">
                 <div className="flex items-center gap-3">
                    <div className={cn("p-2 rounded-lg bg-neutral-100 dark:bg-neutral-900 border border-neutral-200 dark:border-neutral-800 relative z-20")}>
                        {item.type === 'education' ? <GraduationCap className="w-5 h-5 text-teal-500"/> : <Briefcase className="w-5 h-5 text-blue-500"/>}
                    </div>
                    <div>
