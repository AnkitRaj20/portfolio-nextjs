...
const Footer = () => {
  ...
  return (
    <footer className="flex flex-col items-center justify-between px-4 py-12 mx-auto max-w-7xl md:flex-row">
      <p className="mb-8 text-sm text-center text-gray-700 dark:text-white md:text-left md:mb-0">
        © Copyright {fullYear} Ankit Raj. All Rights Reserved.
      </p>
      <div className="flex items-center space-x-6">
        <a href="https://github.com/AnkitRaj20" target="_blank">
          <Image
            src={
              "https://raw.githubusercontent.com/devicons/devicon/6910f0503efdd315c8f9b858234310c06e04d9c0/icons/github/github-original.svg"
            }
            alt="Github Icon"
            width={20}
            height={20}
        ...
        <a href="https://www.linkedin.com/in/ankit-raj-716781254">
